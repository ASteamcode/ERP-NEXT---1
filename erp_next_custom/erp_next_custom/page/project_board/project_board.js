  ...
  <aside class="pb-sidebar">
    ...
    <div class="pb-sidebar-sec">
      ...
      <button class="pb-nav pb-mod-item" data-mod="Prospect">
        <span class="pb-dot" style="background:#3b82f6"></span>Prospect
      </button>
...
function _pb_update_header(wrapper) {
    if (wrapper._pb_view === "prospect") {
        $("#pb-title").text("Prospects");
        $("#pb-subtitle").text("Live data");
        $("#pb-search").attr("placeholder", "Search prospects…");
    ...
    frappe.call({
        ...
        callback(r) {
            ...
            if (typeof PG !== "undefined" && PG.mount) {
                ...
                container.innerHTML = `<div class="pb-empty"><p>Prospect grid unavailable.</p></div>`;
            }
        },
    });
}
