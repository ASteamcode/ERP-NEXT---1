...
def get_prospects(limit=500, offset=0):
    ...
    rows = frappe.get_all(
        ...
        fields=[
            ...
            "custom_site_country", "custom_site_district", "custom_site_city", "custom_site_street",
            "custom_maps_url", "custom_description", "custom_follow_up_date", "custom_follow_up_notes", "custom_position",
            "custom_has_drawing",
    ...
    for i, r in enumerate(rows):
        ...
        result.append({
            ...
            "follow_up_date": str(r.custom_follow_up_date) if r.custom_follow_up_date else "",
            "follow_up_notes": r.custom_follow_up_notes or "",
